...
const BREADCRUMB_SCHEMA = {
  ...
  "@type": "BreadcrumbList",
  "@id": "https://thekhan.io/home-services#breadcrumb",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://thekhan.io" },
    { "@type": "ListItem", "position": 2, "name": "Home Services", "item": "https://thekhan.io/home-services" },
  ],
};

const HOME_SERVICES_SCHEMA = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://thekhan.io/home-services#service",
...
const HOME_SERVICES_FAQ_SCHEMA = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "@id": "https://thekhan.io/home-services#faq",
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much does marketing for home service businesses cost?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "I work with home service businesses across the North Shore and Chicagoland — Deerfield, Highland Park, Lake Forest, Northbrook, Glencoe, Winnetka, Bannockburn, Evanston, and the broader Chicago metro area. Remote clients anywhere in the US welcome if the project fits.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Do you work with home service businesses running multiple service brands?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function HomeServicesPage() {
  ...
  return (
    <Layout activePath="/home-services" contactHref="#contact">
      <SEO
        title="Marketing for Home Service Businesses in Chicago | TheKhan"
        description="Websites, Google Ads, and SEO for Chicago home service businesses. Get your phone ringing every week. You do the work. I make sure people find you."
        ...
        schema={[BREADCRUMB_SCHEMA, HOME_SERVICES_SCHEMA, HOME_SERVICES_FAQ_SCHEMA]}
      />
        ...
        <div className="relative max-w-[1400px] mx-auto">
          <div className={`transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            ...
            <p className="lede mt-10 max-w-2xl">
              Home services marketing that makes your phone ring.
            </p>
            ...
            <div className="mt-14 md:mt-16 space-y-3">
              <p className={`text-ink-quiet text-base md:text-[17px] leading-relaxed opacity-80 transition-all duration-700 delay-[400ms] ${mounted ? 'opacity-80 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                &mdash; I work with a handful of home service businesses at a time.
              </p>
              <p className={`text-ink-quiet text-base md:text-[17px] leading-relaxed opacity-80 transition-all duration-700 delay-[475ms] ${mounted ? 'opacity-80 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                &mdash; Before TheKhan, I built my own home service company to <CountUp to={84} className="font-mono text-accent-light" /> clients. Closed it in March &mdash; the phone still rings from the SEO work I did &mdash; and those calls now go to the home service businesses I work with.
              </p>
              <p className={`text-ink-quiet text-base md:text-[17px] leading-relaxed opacity-80 transition-all duration-700 delay-[550ms] ${mounted ? 'opacity-80 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                &mdash; Serving home service businesses across Chicagoland &mdash; Deerfield, Highland Park, Lake Forest, Northbrook, Glencoe, Winnetka, Wilmette, Evanston, Skokie, Arlington Heights, Naperville, Oak Park, and the rest of the Chicago metro. Remote clients welcome anywhere in the US.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ==================== TEXT MARQUEE — 2-row, exterior/cleaning solid + structural/heavy outlined ==================== */}
          ...
          <div className="grid md:grid-cols-3 gap-6 md:items-stretch mb-16 md:mb-24">
            ...
            <ScrollReveal direction="up" delay={0.05}>
              <a href="#contact" aria-label="See if Foundation is a fit — go to contact form" className="lift md:mt-8 h-full bg-bg-raised rounded-2xl border border-line p-8 flex flex-col cursor-pointer hover:border-accent-line transition-colors">
                ...
                <p className="text-ink-muted text-sm leading-relaxed mb-5">
                  For home service businesses still surviving on referrals and repeat customers.
                </p>
            ...
            <ScrollReveal direction="up" delay={0.1}>
              <a href="#contact" aria-label="See if Engine is a fit — go to contact form" className="lift relative h-full bg-bg-raised rounded-2xl border-2 border-accent p-8 flex flex-col cursor-pointer transition-colors">
                ...
                <p className="text-ink-muted text-sm leading-relaxed mb-5">
                  For home service businesses that want jobs coming in every week &mdash; not just busy season.
                </p>
            ...
            <ScrollReveal direction="up" delay={0.15}>
              <a href="#contact" aria-label="See if Partnership is a fit — go to contact form" className="lift md:mt-8 h-full bg-bg-raised rounded-2xl border border-line p-8 flex flex-col cursor-pointer hover:border-accent-line transition-colors">
                ...
                <p className="text-ink-muted text-sm leading-relaxed mb-5">
                  For home service businesses ready to lock down their service area and pick which jobs to take.
                </p>
                <p className="text-accent text-xs tracking-wide uppercase font-semibold mb-3">
          ...
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3">
              <div className="bg-bg-raised rounded-2xl p-8 border border-line">
                <ContactForm
                  source="home-services-page"
                  subjectPrefix="[Home Services form]"
                  showPhoneField
                  showTradeDropdown
                />
              </div>
